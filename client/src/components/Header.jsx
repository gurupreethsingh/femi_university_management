...
export default function Header() {
  return (
    <Disclosure as="nav">
      <div className="px-2 sm:px-4 lg:px-6 card shadow">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <Menu as="div" className="ml-3 relative">
              ...
              <DisclosurePanel className="absolute right-0 mt-2 w-48 origin-top-right rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                <MenuItem>
                  {({ active }) => (
                    <a
                      href="#"
